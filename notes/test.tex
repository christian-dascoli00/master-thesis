...
\begin{tikzcd}
E\times_B(E\times_BD) \arrow[dd, "\mathrm{proj}_2"] \arrow[rr, "p^*(\pi_2)", shift left] \arrow[rr, "\mathrm{proj}_2"', shift right] &  & E\times_BD \arrow[dd, "\pi_2"] \arrow[rr, "q"] &  & Q \arrow[lldddd, "\delta", bend left] \arrow[lldd, "{\rho_{(D,\zeta)}}"', dashed, bend left] \\
                                                                                                                                     &  &                                                &  &                                                                                              \\
E\times_BD \arrow[dd, "\pi_1"] \arrow[rr, "\pi_2"]                                                                                   &  & D \arrow[dd, "\zeta"]                          &  &                                                                                              \\
                                                                                                                                     &  &                                                &  &                                                                                              \\
E \arrow[rr, "p"]                                                                                                                    &  & B                                              &  &                                                                                             
\end{tikzcd}
\end{equation}
