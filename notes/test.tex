...
\date{}
\author{C. D'Ascoli and A. Cigoli}
...
\end{tikzcd}
  ...
  Observe that the following compositions hold.
  \begin{itemize}
...
Hence, since by \ref{xi coequalizer} $\xi$ coequalizes $(1_E\times_B\xi,1_E\times_B\mathrm{proj}_{2,C})$, it holds that
