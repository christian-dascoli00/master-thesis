...
We recall that the unit $\eta$ of the monad in an object $(C,\gamma)$ is $\langle \gamma, 1_C \rangle$ and the counit $\epsilon$ in an object $(D,\zeta)$ is the morphism $\mathrm{proj}_{2,D}: E\times_BD \to D$ given by the pullback of $p$ along $\zeta: D \to B$.
