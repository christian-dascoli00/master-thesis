...
\begin{tikzcd}
                                                                                                                     &  &                                                                                             &  & C \arrow[d, "p_1'"]  \\
E\times_BC \arrow[rr, "h"] \arrow[rrrrd, "\mathrm{proj}_{2,C}"', bend right] \arrow[rrrru, "\mathrm{proj}_{1,C}", bend left] &  & C\times_BC \arrow[rru, "p_1"] \arrow[rrd, "p_2"'] \arrow[rr, "i"] &  & C\times C             \\
                                                                                                                     &  &                                                                                             &  & C \arrow[u, "p_2'"']
\end{tikzcd}
\]
