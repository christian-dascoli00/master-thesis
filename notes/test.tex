...
We recall that a right adjoint is monadic if the comparison functor $K: (\mathcal{A} \downarrow B) \to (\mathcal{A} \downarrow E)^T$ is an equivalence of categories, where $T=p^*p_!$ is the monad associated to $p$.
\[
