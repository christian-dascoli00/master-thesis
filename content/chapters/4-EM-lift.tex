...
\end{tikzcd}
        ...
        In order to prove that also finite coproducts exists, it suffices to do the same proof for the initial object, using \Cref{coeq for the three diagrams} again.
