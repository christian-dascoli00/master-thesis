...
In this section we aim construct products and coproducts in the Eilenberg–Moore category. Products are quite easy to lift, whereas coproducts need additional conditions.
...
\begin{equation}\label{product lift}
...
\end{tikzcd}
\end{equation}
Clearly, the product is preserved by the forgetful functor of the monad.
