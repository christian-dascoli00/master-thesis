...
\begin{subbox}{}
\begin{proof}
First we prove that $\eta$ is cartesian. Let $g : (D,\delta) \to (D',\delta')$ be a morphism in $(\mathcal{A} \downarrow E)$. Applying \Cref{p^*(f) is a pullback} at $p_!(g)$, we obtain that the following diagram is a pullback.
\[
