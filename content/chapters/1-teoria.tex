...
\begin{mainbox}{}
    \begin{prop}\label{AonE has the con lim that A has}
       For each object $E$ in $\mathcal{A}$, by the previous result, $(\mathcal{A} \downarrow E)$ has all the connected limits that $\mathcal{A}$ has.
    \end{prop}
\end{mainbox}
