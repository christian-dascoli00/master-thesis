...
\begin{mainbox}{}
    ...
    \[
% https://tikzcd.yichuanshen.de/#N4Igdg9gJgpgziAXAbVABwnAlgFyxMJZAJgBoBmAXVJADcBDAGwFcYkQAdDgW3pwAsATt2ABhCDACOAXwAUaAPoBGUouIBKENNLpMufIRQqqNBizaIQAQS06QGbHgJEADBWp0mrdl14DhwACikrKS6tK2uo4GrqTEHmbelmgAegBUsr58QiLBcmGa2lH6zkZxCV4W9umyVuoAvFZceNzwCgBCgZH2ek6GJOWmleypGVn+IuJScooqauqFdg4l-WQuFebsogDk3ct9setDm5aiWh4wUADm8ESgAGaCENxIKiA4EEhunicgkiA0fgwehQdg4ADuECBIIQRRAj2eSDI70+iDecH4WHuOCQAFo3okqmpugiXohkR9XjQMVicWjjkl7MoASBGPQAEYwRgABV6MUsgiwV34OLhpKQ5BolPJYqeZIALFLUUpZYjEABWJVfVVkyUopCKkA07F4gnDSzNLCMWDANQRGhszk8vmlVkwE06iVaxCG410s2-S3WmC25T21kcrm86KuwXC0V2cU+72an6MoM2mQs6GgywQqHAqCwxNyg3egBsDKqzBJpY1FYdWDAVSg9AxlxZhJ8HBgAA8sHAcHAAIQAAi4o4TDzrAHZvb7MSb6WmqoJmQ7I86Y4YQHGRbW1XP9cmjYu6fiq+w18QD2Sj9K9V2LT3+4O4KOxxOEBundGVlehX3Rtm3YVt21BaRKGkIA
\begin{tikzcd}
    C \arrow[rdd, "r_1"', shift right] \arrow[rdd, "r_2", shift left] \arrow[dd, "\exists ! \ s"', dashed]    &                                                                                & C'                                                                         \\
                                                                                                              &                                                                                &                                                                            \\
    p^*(\mathrm{Eq}(q)) \arrow[d] \arrow[r, "\tilde{p_2}", shift left] \arrow[r, "\tilde{p_1}"', shift right] & p^*(A)=A\times_BE \arrow[d] \arrow[r, "\tilde{q}", two heads] \arrow[ruu, "u"] & {p^*(\mathrm{Coeq}(p_1,p_2))} \arrow[d] \arrow[uu, "\exists! \ t", dashed] \\
...
\begin{subbox}{}
    \begin{proof}
        ...
        \[
% https://tikzcd.yichuanshen.de/#N4Igdg9gJgpgziAXAbVABwnAlgFyxMJZARgBoAGAXVJADcBDAGwFcYkQBBAagCEQBfUuky58hFGQBM1Ok1bsAwgKEgM2PASJliMhizaIQ5ZcPVii5CrrkHOJ1SI3jkkqzT3zDffjJhQA5vBEoABmAE4QALZIliA4EEiSgqER0YhkcQmISSrhUUgAzDTxMe427AA6Ffg49AD6xPZ5aQAsxVmxHrZVNfWSIDSM9ABGMIwACo7mhmFY-gAWOE2phe1IGaNgUEgAtAWd5YYhAyBDoxNTmjNzi8v5iG2Z6zSb24j7Zfrs-ndpRU-ZT6eEBVJhoeb0E5nMaTMxXECzBZLZIgZpIR4lQGyL6GKqjWq-UoAnIpe6xTEbGBbXYfbHA5AhUj+ShQkYwy7iBE3ZGUfhAA
\begin{tikzcd}
    A \arrow[r, "\iota_1"] \arrow[rdd, "f"', bend right] \arrow[rd, "\alpha"'] & A+B \arrow[d] \arrow[d] \arrow[dd, "{[f,g]}"', bend right] & B \arrow[l, "\iota_2"'] \arrow[ldd, "g", bend left] \arrow[ld, "\beta"] \\
                                                                               & 0                                                          &                                                                         \\
                                                                               & C \arrow[u]                                                &                                                                        
    \end{tikzcd}
    \]
...
\begin{tikzcd}
    ...
    \begin{minipage}{0.30\textwidth}
        % https://tikzcd.yichuanshen.de/#
    \begin{tikzcd}
    & Q \arrow[rd, "m", tail] &                       \\
    A \arrow[rr, "f"] \arrow[ru, "e", two heads] \arrow[rd, "\alpha"] &                         & B \arrow[ld, "\beta"] \\
    & 0                       &                      
    \end{tikzcd}
        \end{minipage}
        \begin{minipage}{0.30\textwidth}
...
\begin{tikzcd}
    ...
    \end{minipage}
    \begin{minipage}{0.30\textwidth}
% https://tikzcd.yichuanshen.de/#N4Igdg9gJgpgziAXAbVABwnAlgFyxMJZABgBpiBdUkANwEMAbAVxiRAEUQBfU9TXfIRQAmclVqMWbAELdeIDNjwEiARlKrx9Zq0Qhi3cTCgBzeEVAAzAE4QAtkjIgcEJOok62D6jjpYGbL7+cla2DojuLkiiHlJ6ADrxAEYwviEgNvaOPq6IMdpxIIkpvgAEDlwUXEA
\begin{tikzcd}
Q \arrow[rr, "m", tail] \arrow[rd, "\beta m"] &   & B \arrow[ld, "\beta"] \\
                                              & 0 &                      
\end{tikzcd}
    \end{minipage}
