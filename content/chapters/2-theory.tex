...
\begin{subbox}{}
    \begin{proof}
        ...
        We proceed to prove that each equivalent relation is the kernel pair of some arrow. Consider an equivalence relation $R$ in $\mathcal{X}^T$. Then, under the forgetful functor $U^T$, $R$ is an equivalence relation in $\mathcal{X}$. $\mathcal{X}$ is exact, so $R$ is the kernel pair of some arrow. Since $U^T$ creates all the limits that $\mathcal{X}$, we can conclude that $R$ is the kernel pair in $\mathcal{X}^T$ of some arrow.
