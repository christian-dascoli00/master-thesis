...
T(\mathrm{Eq}(\tilde{q})) \arrow[dd, "\xi_{\mathrm{Eq}(\tilde{q})}", dashed] \arrow[rr, crossing over, "T(r_1)", pos=0.25, shift left] \arrow[rr, crossing over, "T(r_2)"', pos=0.25 , shift right] &                                                                & T(A\times_BC) \arrow[ru]  \arrow[rr, crossing over, "T(\tilde{q})", pos=0.25] &                                    & T(C) \arrow[ru] &                 \\
    & K \arrow[rr, shift left] \arrow[rr, shift right]               &                                                                                    & A \arrow[rr, "q", two heads]       &                                     & B               \\
\mathrm{Eq}(\tilde{q}) \arrow[rr, "r_2"', shift right] \arrow[rr, "r_1", shift left]                                        &                                                                & A\times_BC \arrow[from=uu, crossing over, pos=0.25,  "\xi_{A\times_BC}"] \arrow[ru] \arrow[rr, "\tilde{q}"', two heads]                          &                                    & C \arrow[from=uu, crossing over, "\xi_C", pos=0.25] \arrow[ru]                        &                
\end{tikzcd}
\]