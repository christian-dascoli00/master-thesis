...
\begin{tikzcd}
    ...
    \]
        ...
        \[
        % https://tikzcd.yichuanshen.de/#N4Igdg9gJgpgziAXAbVABwnAlgFyxMJZAJgBpiBdUkANwEMAbAVxiRAEEQBfU9TXfIRQAWclVqMWbAELdeIDNjwEiAZlKrx9Zq0QgAinL5LBRMgAYtk3SAAqACnYBKIwv7KhyUZerapeh2kXHmMBFRR1AEYrHTYHfWD5RTDPczFfazYAYVdkjyI0nwlYvQARbnEYKABzeCJQADMAJwgAWyQ0kBwIJDJi-xBWagY6ACMYBgAFd1M9JqxqgAscEGpFmDooNhwAdwh1zYQQkGa23upupEiLuiwGbdv7jJKQduGxiemTcJB5pZXjqd2ohOpdENd+jYGq4gUh1F0eiDAS1gaIEVdkWdEPCwcJMcCcYiAKxrDZbPS7fZko7yWGIEnoxB42kopAANguiM6cEWWAaK3B+KQAHZOXDqDy+QLIkLEKLGfDJfykABaGUsrEcxnc3nKxBqrgULhAA
\begin{tikzcd}
    D \arrow[rr, shift right] \arrow[rr, shift left] &  & T(A) \arrow[dd] \arrow[rr] \arrow[rd, two heads] &                          & T(B) \arrow[dd] \\
                                                     &  &                                                  & T(Q) \arrow[ru]          &                 \\
    ...
    \end{tikzcd}
        ...
        Picking up where we left off, consider $f$ and its kernel pair $(\mathrm{Eq}(q),r_1,r_2)$. Since $U^T$ creates all the limits that $\mathcal{X}$ has, we can lift the kernel pair $(\mathrm{Eq}(q),r_1,r_2)$ to a kernel pair in $\mathcal{X}^T$. Let $\xi_\mathrm{Eq}$ be the structure of algebra of $\mathrm{Eq}$.

        We know that $U^T$ creates all the colimits that $\mathcal{X}$ has and $T$ preserves. Hence, $U^T$ creates all coequalizers that $\mathcal{X}$ has of kernel pairs arising from $\mathcal{X}^T$, once the algebra structure is forgotten. Observe that $e$ is such a coequalizer, in fact it is a regular epi and by (citazione) $f$ and $e$ has the same kernel pair. Thus $(\mathrm{Eq}(q),r_1,r_2)$ is also the kernel pair of $e$. Hence, by \Cref{coeq of the kernel pair}, $e$ is the coequalizer of $(\mathrm{Eq}(q),r_1,r_2)$. In particular by the creation of such colimit we proved that $Q$ has the structure of algebra, called $\xi_Q$, and that $e$ can be lifted to a coequalizer in $\mathcal{X}^T$.
        \[
...
\begin{tikzcd}
    T(\mathrm{Eq}) \arrow[rr, "T(r_2)"', shift right] \arrow[rr, "T(r_1)", shift left] \arrow[dd, "\xi_\mathrm{Eq}", dashed] &  & T(A) \arrow[dd, "\xi_A"] \arrow[rd, "T(e)"', pos=0.7, two heads] \arrow[rr, "T(f)"] &                                             & T(B) \arrow[dd, "\xi_B"] \\
                                                                                                                             &  &                                                                           & T(Q) \arrow[ru, "T(m)"', pos=0.3] &                          \\
    \mathrm{Eq} \arrow[rr, "r_2"', shift right] \arrow[rr, "r_1", shift left]                                                &  & A \arrow[rd, "e"', two heads] \arrow[rr, "f", pos=0.25]                             &                                             & B                        \\
...
\]
        ...
        It remains to prove the last condition of a regular category, that is the pullback stability of regular epi.
...
% https://tikzcd.yichuanshen.de/#N4Igdg9gJgpgziAXAbVABwnAlgFyxMJZAZgBoAmAXVJADcBDAGwFcYkQBBEAX1PU1z5CKAKwVqdJq3YAhHnxAZseAkTEAGCQxZtEIACoAKGQEp5-ZUKJlNNbdL1GOZ3hcGqUARnF2pukAA6AQC29DgAFgBOwcAAogCO3IbxLgpK7sLI3raSOuxGQaER0XGJySapbiqZ5KTEWn7sAMLmigLVRAAsdQ15egAirekdKLWevQ4Ghk2VbZYeyN3jvn1T-bPDVijqPSuTQ+1byDvLufvcEjBQAObwRKAAZpEQwUhkIDgQSAAcriBPLzeNE+SHIfwBr0QOw+X0QnnBz0h0JBiAAbAjAYgAJzA2EAdgxkNRuKQBIUEJ+JLRhNBVPh5MRSG8MNJNMQ3ypWLZtRZ2LZ7xR6jZYl57zg4SwDxwSAAtPTHozECKUWKJVKmWzurzoeLJdLEHLNVSdWr9fL-orlbDOmzPMjrbb7UhiSBdeqDeaKXDmSiRLafbC7f6qRzXabZZ7FZ4A5Sw3qNQzMXaqS63WaLtwgA
\[
\begin{tikzcd}
    & T(\mathrm{Eq}(q)) \arrow[rr, shift left] \arrow[rr, shift right] \arrow[dd] &                            & T(A) \arrow[ld] \arrow[rr] \arrow[dd] &                 & T(B) \arrow[dd] \arrow[ld] \\
{} \arrow[ru] \arrow[dd] \arrow[rr, shift left] \arrow[rr, shift right] &                                                                             & T(C) \arrow[dd] \arrow[rr] &                                       & T(D) \arrow[dd] &                            \\
    & \mathrm{Eq}(q) \arrow[rr, shift left] \arrow[rr, shift right]               &                            & A \arrow[rr] \arrow[ld]               &                 & B \arrow[ld]               \\
{} \arrow[ru] \arrow[rr, shift left] \arrow[rr, shift right]            &                                                                             & C \arrow[rr]               &                                       & D               &                           
\end{tikzcd}
\]