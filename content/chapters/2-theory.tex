...
\begin{mainbox}{}
    ...
    \begin{subbox}{}
        \begin{proof}
    Consider the following diagram (RECALL A.0.7!!!!!!!)
...
\begin{tikzcd}
    ...
    $(3 \implies 2)$ Suppose there exists $\mathcal{X}$ semiabelian category and a monadic functor $U: \mathcal{A} \to \mathcal{X}$ satisfying the stated conditions. First we need to verify that $\mathcal{A}$ is exact.
\end{proof}
\end{subbox}
