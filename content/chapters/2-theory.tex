...
\begin{tikzcd}
    ...
    Now we want to prove that $(\mathcal{A} \downarrow 0)$ is exact, by the exactness of $\mathcal{A}$.
    Consider an equivalence relation in $\mathcal{A} \downarrow 0$. Since $\mathcal{A}$ is exact, such equivalence relation is a kernel pair in $\mathcal{A}$. 
    \end{proof}
\end{subbox}
