...
\end{tikzcd}
    \]
        ...
        \[
% https://tikzcd.yichuanshen.de/#N4Igdg9gJgpgziAXAbVABwnAlgFyxMJZAJgBpiBdUkANwEMAbAVxiRAEEQBfU9TXfIRQAWclVqMWbAELdeIDNjwEiAZlKrx9Zq0QgAinL5LBRMgAYtk3SAAqACnYBKIwv7KhyUZerapeh2kXHmMBFRRzMV9rNgANV0Uwz0ifCR02AE0E91MUdQBGK3SA+31g8RgoAHN4IlAAMwAnCABbJEiQHAgkMjT-EFZqBjoAIxgGAAUc8JBGrCqACxwQagWYOig2HAB3CDWNhBCQJtae6i6kfPO6LAYtm7vo4pA2odHxqZMZucXlo5O2ogOhdEFc+jZ6q4AUh1J1ukCnv0ADpIgAeWAA+px-s1AaI4ZdETYUeiMbIcadELCQfi-DYHPVgvJoYgAKzneEdOALLD1ZagimAgBsHJh1G5vP5+UFSBFBKp4p5fKQAFppczcUh2fKuUr+WqZQr5QB2IlsBwwFxvMaTaZCWbzJZQzWIU3y2kxEotK0gYY2z5JNg-J1cChcIA
\begin{tikzcd}
Y \arrow[rr, shift right] \arrow[rr, shift left] &  & T(A) \arrow[dd, "\xi_A"] \arrow[rr, "T(f)"] \arrow[rd, "T(e)"'] &                          & T(B) \arrow[dd, "\xi_B"] \\
                                                 &  &                                                                 & T(Q) \arrow[ru, "T(m)"'] &                          \\
...
\end{tikzcd}
        ...
        First, we show that there exists a unique morphism $g:(T(A+B),\mu_{A+B} \to (K,\xi_K)$ in $\mathcal{X}^T$ such that $g(\eta_{A+B})\iota_i=f_i$ for $i=1,2$. Let define $g=\xi_K T[f_1,f_2]$. It is a morphism in $\mathcal{X}^T$, in fact the following diagram commutes.
        \[
...
\end{tikzcd}
        \]
        Suppose now there exists another morphism $g':(T(A+B),\mu_{A+B}) \to (K,\xi_K)$ such that $g'(\eta_{A+B})\iota_i=f_i$ for $i=1,2$. Then we have that
        \begin{align*}
