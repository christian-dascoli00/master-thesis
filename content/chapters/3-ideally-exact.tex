...
\]
        ...
        Let $q:T(A+B) \to Q$ be the coequalizer, and $\xi_Q$ be the algebra structure of $Q$. We aim to prove that $(Q,\xi_Q)$ is the coproduct of $(A,\xi_A)$ and $(B,\xi_B)$ in $\mathcal{X}^T$. First we need to exhibit the canonical injections $\iota_{Q,1}$ and $\iota_{Q,2}$. They are respectively
