...
\begin{subbox}{}
    \begin{proof}
        Consider the first diagram of parallel arrows in $\mathcal{X}^T$, and $p$ its coequalizer.
        \[
...
\end{tikzcd}
\]
Note that each parallel arrow in $\mathcal{X}^T$ respectively to the top and bottom morphism of the second diagram.
    \end{proof}
\end{subbox}
