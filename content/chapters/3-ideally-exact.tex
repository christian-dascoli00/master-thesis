...
T(A)  \arrow[dd, "\xi_A"'] &  & Q                            &                                                                    & T^2(K)  &                          & B \arrow[lddd, "f_2"', bend left=20] \arrow[llld, "\eta_{A+B}\iota_2"']                              \\
                                                                                                     &  &                                                             & T(A+B) \arrow[rd, "{T[f_1,f_2]}"'] \arrow[lu, "q"]                 &                                                & T(K) \arrow[dd, "\xi_K"] &                                                                                                   \\
A \arrow[rrru, "\eta_{A+B}\iota_1"'] \arrow[rrrrrd, "f_1", bend right=25]                               &  &                                                             &                                                                    & T(K) \arrow[rd, "\xi_K"']                      &                          &                                                                                                   \\
                                                                                                     &  &                                                             &                                                                    &                                                & K                        &                                                                                       
\arrow[from=3-1, to=2-4, "T(\eta_{A+B}\iota_1)", crossing over]
\arrow[from=3-5, to=5-5, "\mu_K", crossing over] 
\arrow[from=3-5, to=4-6, "\mu_K", crossing over]
\arrow[from=1-3, to=4-6, "T(h)", bend right, crossing over]
\arrow[from=3-3, to=6-6, "h", bend right, crossing over]
\arrow[from=3-1, to=4-6, "T(f_1)"', bend right=25, crossing over]
\arrow[from=1-7, to=4-6 , "T(f_2)"', bend left=20, crossing over]            
\end{tikzcd}
        \]
