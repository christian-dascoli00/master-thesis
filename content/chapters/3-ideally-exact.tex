...
\end{tikzcd}
        ...
        Once we have the canonical injections, we need to show that they satisfy the universal property of coproducts in $\mathcal{X}^T$. Let $f_i:(A_i,\xi_i) \to (K,\xi_K)$ for $i=1,2$ in $\mathcal{X}^T$. We aim to prove that there exists a unique morphism $h:(Q,\xi_Q) \to (K,\xi_K)$ in $\mathcal{X}^T$ such that $h\iota_{Q,i} = f_i$ for $i=1,2$.
...
\end{tikzcd}
        ...
        \begin{align*}
            ...
            &\implies g=g'
        \end{align*}
        where we used the unicity in the universal property of the unit and the fact that $g$ and $g'$ are morphisms in $\mathcal{X}^T$. So $g$ is unique. Moreover, we have that $gT(\iota_i) = g (\eta_{A+B}) \iota_i \xi_i$ for $i=1,2$. In fact, we have that
        \[
...
\end{align*}
        ...
        and by the unicity of $g$, we have that $h$ is the unique morphism in $\mathcal{X}^T$ satisfying such relaation.
                \[
...
\begin{tikzcd}
                                                                                                     ...
                                                                                                     &  &                                                             & T^2(A+B) \arrow[rd, "{T^2[\ldots,f_i,\ldots]}"] \arrow[lu, "T(q)"'] &                                                &                          &                                                                                                   \\
