...
\end{align*}
        ...
        \[ h\iota_{Q,i} = h q (\eta_{A+B}) \iota_i = g (\eta_{A+B}) \iota_i = f_i \]
        and by the unicity of $g$, we have that $h$ is the unique morphism in $\mathcal{X}^T$ satisfying $h\iota_{Q,i} = f_i$ for $i=1,2$.
                \[
