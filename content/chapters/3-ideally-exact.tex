...
\end{tikzcd}
    ...
    Finally we want to prove that $!:0 \to 1$ is a regular epi in $\mathcal{A}$. We already know that $U(m)$ is an iso. Since $U$ reflects iso, then $m$ is an iso in $\mathcal{A}$. Thus $! = me$ is a regular epi.
