...
\begin{subbox}{}
    \begin{proof}
        ...
        because $\mathcal{A}$ is protomodular, hence Mal'tsev. By \Cref{ideally exact has essentially nullary monad} the unit of the adjunction associated to $U$ is essentially nullary, then, by \Cref{T-algebra in the reflexive relation}, we have that
...
Given an ideally exact category $\mathcal{A}$, we call the elements of $\mathrm{NSub}(U(A))$ the $U$-ideals of $\mathcal{A}$. This theorem gives the correspondence between $U$-ideals and regular epis, which play the role of quotients.
