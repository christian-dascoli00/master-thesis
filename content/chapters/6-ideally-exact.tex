...
\end{tikzcd}
\]
Observe that ${\langle 1_X,1_X\rangle}$ is a $T$-algebra morphism, in fact given the product structure from \Cref{prodcut lift} of $X\times X$ on the category $\mathcal{X}^T$
\[
