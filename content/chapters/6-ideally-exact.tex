...
Observe that ${\langle 1_X,1_X\rangle}$ is a $T$-algebra morphism, in fact given the product structure \eqref{product lift} of $X\times X$ in the category $\mathcal{X}^T$
\[
...
\end{tikzcd}
\]
Thus we have $s$ and $\langle r_1,r_2 \rangle$ morphisms whose composition is the $T$-algebra morphism $\langle 1_X,1_X \rangle$. By \Cref{induced algebra between morphisms} there exists a unique $T$-algebra structure on $R$ making $s$ and $\langle r_1,r_2 \rangle$ $T$-algebra morphisms.
    \end{proof}
\end{subbox}
