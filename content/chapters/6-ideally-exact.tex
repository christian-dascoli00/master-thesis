...
We already saw in \Cref{Ideally exact categories} that an we can consider as functor of the definition the one induced by the morphism $!:0 \to 1$, to form the pullback functor. One can ask whether or not this functor is, up to equivalence of categories, the pullback functor. We aim to answer this question. First, we need the following proposition.
...
Then the adjunction induced in the $0$
...
is an equivalence adjunction. 
\end{prop}
\end{mainbox}
