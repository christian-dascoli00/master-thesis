...
\end{tikzcd}
\]
so $U^0!^*(A) = U^0((0 \times A, \mathrm{proj}_1)) = \mathrm{Ker}(U(\mathrm{proj}_1)) \cong \mathrm{Ker}(\mathrm{proj}_1: U(0) \times U(A) \to U(A)) \cong U(A)$
\end{rem}
\end{rembox}
