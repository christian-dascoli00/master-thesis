...
\begin{subbox}{}
    \begin{proof}
        ...
        in fact $\mathcal{A}$ is exact, hence kernel pairs and equivalence relations correspond to each others, and by \Cref{kernel pair of the coeq} and \Cref{coeq of the kernel pair} we have the given isomorphism. Furthermore
