...
\begin{subbox}{}
    \begin{proof}
        An ideally exact category is exact and protomodular, thus Mal'tsev. Then by \Cref{exact and Maltsev cat has reflexive coeq} it has reflexive coequalizers. Then \Cref{algebras category has colim if the base category has coprod} implies that the category has all the finite colimits.
    \end{proof}
\end{subbox}
