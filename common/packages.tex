...
\newtcolorbox{subbox}[1]{
  ...
  borderline west={3pt}{0pt}{black!30!white}, % Riga verticale a sinistra
  breakable,
...
\Crefformat{theo}{\emph{Theorem~#2#1#3}}
\Crefformat{lemma}{\emph{Lemma~#2#1#3}}
\Crefformat{cor}{\emph{Corollary~#2#1#3}}
\Crefformat{prop}{\emph{Proposition~#2#1#3}}
\Crefformat{propr}{\emph{Property~#2#1#3}}
\Crefformat{defi}{\emph{Definition~#2#1#3}}
\Crefformat{rem}{\emph{Remark~#2#1#3}}
\Crefformat{ex}{\emph{Example~#2#1#3}}