...
% Etichette personalizzate per cleveref
\crefname{theo}{\emph{Theorem}}{\emph{Theorems}}
\crefname{lemma}{\emph{Lemma}}{\emph{Lemmas}}
\crefname{cor}{\emph{Corollary}}{\emph{Corollaries}}
\crefname{prop}{\emph{Proposition}}{\emph{Propositions}}
\crefname{propr}{\emph{Property}}{\emph{Properties}}
\crefname{defi}{\emph{Definition}}{\emph{Definitions}}
\crefname{rem}{\emph{Remark}}{\emph{Remarks}}
\crefname{ex}{\emph{Example}}{\emph{Examples}}
