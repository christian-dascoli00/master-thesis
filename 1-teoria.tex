...
Now we want to prove that the counit is a natural trasfromation. Consider $f : (A,\alpha) \to (A',\alpha')$ a morphism in $(\mathcal{A} \downarrow B)$, we want to prove that the following diagram commutes:
\[
