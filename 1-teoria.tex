...
[TO DO] We need to check that the unit and counit are natural transformations.
...
Let check the composing the projections of $E\times_BA$ with $(\tilde{\mathrm{proj}_2}) (\langle \mathrm{proj}_{1,E\times_BA}, 1_{E\times_BA} \rangle)$ is the same of composing those projection with $\mathrm{Id_{(E\times_BA,\mathrm{proj}_1)}}$. Following the first composition
