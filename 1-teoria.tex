...
In order to prove that $\eta$ is cartesian, ie the naturality diagrams are pullback, we consider the bottom and the total commutative diagrams below. Let $g : (D,\delta) \to (D',\delta')$ be a morphism in $(\mathcal{A} \downarrow E)$. Since both the diagrams are pullback, it follows that the top diagram is a pullback.
\[
